...
if($cpf_usuario == ""){
  $cpf_usuario = @$_SESSION['data_hora'];
}
  ...
  <div class='checkout margem-topo'>
    <div class="row">
      <div class="col-md-6 col-sm-12">
        ...
        <h1><span id="cifrao">R$</span> <span id="sub_total"><?php echo $sub_total ?></span></h1>
        ...
        <div class="dados-usuario row">
          ...
          <?php if(@$_SESSION['cpf_usuario'] == ""){ 
            ...
            <div class="col-md-7">
              ...
              <input type="text" class="form-control form-control-sm" id="nome" name="nome" placeholder="Seu Nome" <?php echo @$required ?>>
            </div>

            <div class="col-md-5">
              <label class="text-dark" for="exampleInputEmail1">WhatsApp</label>
              <input type="text" class="form-control form-control-sm" id="telefone" name="telefone" placeholder="WhatsApp Se Tiver">
            </div>

            <div class="col-md-7">
              <label class="text-dark" for="exampleInputEmail1">Email</label>
              <input type="text" class="form-control form-control-sm" id="email" name="email" placeholder="Seu Email" <?php echo @$required ?>>
            </div>

            <div class="col-md-5">
             <label class="text-dark" for="exampleInputEmail1">Cpf</label>
             <input type="text" class="form-control form-control-sm" id="cpf" name="cpf" placeholder="Seu CPF" <?php echo @$required ?>>
           </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var total_pg = "<?=$sub_total?>";
     var valorFormatado = total_pg.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
        $('#valor-pgto').text(valorFormatado);
...
<div class="modal fade" id="modal-pix" tabindex="-1" role="dialog" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Pagar com Pix - Valor: <span id="valor-pgto"></span> </h4>
        <a href="painel-cliente/index.php?acao=pedidos" type="button" class="close" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </a>
      </div>
      <div class="modal-body">
       <span><img src="images/pix.png" width="100%"></span>

      <p align="center">Após efetuar o Pagamento<a href="painel-cliente/index.php?acao=pedidos" class="text-danger"> clique aqui </a> para ir para o painel dos Pedidos. </p>        
    ...
    $.ajax({
      ...
      success: function(result){
        if(taxa_fixa == 'Sim'){
          ...
          var valorFormatado = total_final.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });

          $('#cifrao').text('');
          $('#sub_total').text(valorFormatado);
          $('#valor-pgto').text(valorFormatado);
