<?php 
if(@$_SESSION['data_hora'] == ""){
  $_SESSION['data_hora'] = date('Y-m-d H:m:i');
}
...
<div class="modal fade" id="modal-carrinho" role="dialog">
  ...
  <div class="modal-body">
    ...
    <?php if(@$_SESSION['nivel_usuario'] == 'Admin' || @$_SESSION['nivel_usuario'] == 'Balconista'){ 

      echo 'Você não pode Inserir Produtos logado como Administrador ou Balconista!';
     }else{ ?> 
