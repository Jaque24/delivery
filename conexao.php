...
$res2 = $pdo->query("SELECT * from config");
  $dados2 = $res2->fetchAll(PDO::FETCH_ASSOC);
  $linhas = count($dados2);
  if($linhas == 0){
  	$pdo->query("INSERT INTO config (previsao_minutos, taxa_entrega, abertura, fechamento, pedido_whats, banner_login) values (30,5, '16:00', '00:00', 'Não', 'login.jpg')");
  }else{
    ...
    $pedido_whats = @$dados2[0]['pedido_whats'];
    $banner_login = @$dados2[0]['banner_login'];
  }
