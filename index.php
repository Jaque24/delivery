  ...
  <div class="container">
    <div class="row row-40 justify-content-center">
      <div class="col-sm-8 col-md-7 col-lg-6 wow fadeInLeft" data-wow-delay="0s">
        <div class="product-banner"><img src="images/banner/panqueca.png" alt="" width="570" height="715"/>
      ...
      <div class="col-md-5 col-lg-6">
        <div class="row row-30 justify-content-center">
          ...
          <?php 
          $res = $pdo->query("SELECT * from produtos where adicional is null and ativo = 'Sim' order by vendas desc LIMIT 4");
