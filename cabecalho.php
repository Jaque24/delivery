            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a title="Ir para Página Inicial" class="brand" href="index.php"><img src="images/logo.png" alt="" width="300" height="100"/></a></div>
                </div>
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    <!-- RD Navbar Basket-->
                    <div class="rd-navbar-basket-wrap">
                      <button class="rd-navbar-basket fl-bigmug-line-shopping198" data-rd-navbar-toggle=".cart-inline"><span id="total_itens_3"></span></button>
                    ...
                    </div><a class="rd-navbar-basket rd-navbar-basket-mobile fl-bigmug-line-shopping198" href="produtos" ><span id="total_itens_4"></span></a>
                    <!-- RD Navbar Search-->
                  ...
                  <ul class="rd-navbar-modern-contacts">
                    <li>
                      <div class="unit unit-spacing-sm">
                        ...
                        <div class="unit-body"><a target="_blank" title="Ir para o Whatsapp" class="link-phone" href="http://api.whatsapp.com/send?1=pt_BR&phone=5531975275084">19 97412-0425</a></div>
                      </div>
                    </li>
                    <li>
                      <div class="unit unit-spacing-sm">
                        <div class="unit-left"><span class="icon fa fa-location-arrow"></span></div>
                        <div class="unit-body"><a class="link-location" href="#">Rua José Leblon Canhestro 222, Bairro Monte alegre 2, Paulinia 13142-466
                    ...
                    <li>
                      <div class="unit unit-spacing-sm">
                        ...
                        <div class="unit-body"><a class="link-email" href="mailto:#">jaque-cristina21@outlook.com.br</a></div>
                      </div>
                    </li>
                  </ul>
