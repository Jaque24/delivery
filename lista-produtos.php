     ...
     <!--PRODUTOS MAIS VENDIDOS -->
      <div class="col-md-12 col-lg-12">
        ...
        $limite = $pagina * $itens_por_pagina;
          ...
          $res = $pdo->query("SELECT * from produtos where ativo = 'Sim' order by vendas desc LIMIT $limite, $itens_por_pagina");
          ...
          $res_p = $pdo->query("SELECT * from produtos where ativo = 'Sim'");
